...
.field{display:flex;align-items:center;gap:8px;flex:0 0 auto;width:280px;height:36px;padding:0 16px;border:1px solid #C9CED4;border-radius:2px;background:#fff}
